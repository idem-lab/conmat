...
* `per_capita_household_size` is the household size for that population, in our case we have a helper function, `get_per_capita_household_size` which works for each LGA in Australia.
