...
-   Conmat utilizes the contact data and the population data given to fit a GAM model which models the number of contacts using the age parameters of the participants as well the contacts and the intergenerational patterns while accounting for the probability that a person of the other age goes to the same school/work and the setting.

-   To do this, conmat takes the contact data and uses the following functions to add modelling features like the population distribution of contact ages, fraction of population in each age group that attend school/work as well as the offset according to the settings.
