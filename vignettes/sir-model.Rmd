...
transmission_matrix$home <- matrix(0.05, nrow = 9, ncol = 9)
transmission_matrix$work <- matrix(0.05, nrow = 9, ncol = 9)
transmission_matrix$school <- matrix(0.05, nrow = 9, ncol = 9)
transmission_matrix$other <- matrix(0.05, nrow = 9, ncol = 9)
```
...
world_data <- socialmixr::wpp_age() %>%
    mutate(
        new_lower_age = if_else(lower.age.limit >= 80, 80L, lower.age.limit)
    ) %>%
...
transmission_matrix$home <- matrix(0.1, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$work <- matrix(0.1, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$school <- matrix(0.1, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$other <- matrix(0.1, nrow = n_finite_states, ncol = n_finite_states)
...
S0 <- rep(999, times = n_finite_states)
...
```{r plot-conmat-prem}
ggplot(conmat_prem_soln, aes(x = time, y = value, colour = name, linetype = type)) +
    geom_line() +
    labs(x = "Time", y = "Value", colour = "State", linetype = "Model")
```
