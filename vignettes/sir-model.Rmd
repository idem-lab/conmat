...
transmission_matrix$home <- matrix(4, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$work <- matrix(4, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$school <- matrix(4, nrow = n_finite_states, ncol = n_finite_states)
transmission_matrix$other <- matrix(4, nrow = n_finite_states, ncol = n_finite_states)
