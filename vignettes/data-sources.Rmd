...
```{r}
#| label: abs-education-state-2020
...
```{r}
#| label: eyre-transmission-probabilities
...
```{r}
#| label: eyre-transmission-probabilities-plot
library(ggplot2)
library(stringr)
library(dplyr)
eyre_transmission_probabilities %>%
