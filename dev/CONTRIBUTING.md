...
This outlines how to propose a change to conmat. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("idem-lab/conmat", fork = TRUE)`.
...
of Conduct](https://idem-lab.github.io/conmat/dev/CODE_OF_CONDUCT.md).
