...
population data by state for 2016. The data sourced from 2016 Census -
Employment, Income and Education through TableBuilder have been randomly
adjusted by the ABS to avoid the release of confidential data.
...
- state:
  ...
  String. Abbreviated name of state or territory, e.g., 'NSW', 'VIC',
  'QLD' and so on.
...
- total_population:
  ...
  Total population belonging to the age.
