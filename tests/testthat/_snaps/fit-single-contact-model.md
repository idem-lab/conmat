...
---
    ...
    Output
      ...
      [31] "ti(intergenerational,age_from).1"  "ti(intergenerational,age_from).2" 
      [33] "ti(intergenerational,age_from).3"  "ti(intergenerational,age_from).4" 
      [35] "ti(intergenerational,age_from).5"  "ti(intergenerational,age_from).6" 
      [37] "ti(intergenerational,age_from).7"  "ti(intergenerational,age_from).8" 
      [39] "ti(intergenerational,age_from).9"  "ti(intergenerational,age_from).10"
      [41] "ti(intergenerational,age_from).11" "ti(intergenerational,age_from).12"
      [43] "ti(intergenerational,age_from).13" "ti(intergenerational,age_from).14"
      [45] "ti(intergenerational,age_from).15" "ti(intergenerational,age_from).16"
