...
#'   model fitting in [add_school_work_participation()], which is used in [fit_single_model()]. The data is summarised from `data_abs_state_work`,
...
#'   model fitting in [add_school_work_participation()], which is used in [fit_single_model()]. The data is summarised from `data_abs_state_education`,
#'   see `?data_abs_state_education` for more details.
#'
#' @format A data frame with 116 rows and 2 variables:
#' \describe{
#'   \item{age}{0 to 115}
#'   \item{work_fraction}{fraction of popoulation at school}
#' }
#' @source {Census of Population and Housing, 2016, TableBuilder}
"abs_avg_school"
