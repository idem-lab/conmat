...
#'   \item{lga}{a character string denoting the official name of Local Government Area. For example, 'Albury (C).'}
...
#'   \item{proportion}{a number denoting the measure of the ratio of educated population and total population belonging to the age i.e, population_educated / total_population}
#'   \item{anomaly_flag}{a logical variable with values TRUE and FALSE that flags the abnormal observations in the data such as total population lesser than population_educated as TRUE.  }
#' }
