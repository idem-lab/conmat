...
#'
#' A dataset containing data digitised from "The impact of SARS-CoV-2 vaccination on Alpha & Delta variant transmission", by David W Eyre, Donald Taylor, Mark Purver, David Chapman, Tom Fowler, Koen B Pouwels, A Sarah Walker, Tim EA Peto (\doi{https://doi.org/10.1101/2021.09.28.21264260}.
...
#' \describe{
#'   \item{setting}{"household", "household_visitor", "work_education", or "events_activities"}
...
#'   \item{contact_age_5y}{If contact is between ages 0-4, in 5 year bins up to 100}
