...
[njt: should we mention the link/family?]
...
[njt: do we need to mention that we need to do the exponentiated sum, since these are on the log scale?]
...
[njt: OK with putting these as dot points?]
...
[njt: should we reference that contact patterns are known to differ?]
...
[njt: should we have conmat as `conmat`]
