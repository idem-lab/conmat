...
There are currently few options for a user to generate their own synthetic contact matrices. [TODO add references/examples - e.g., socialmixr].
Existing methods to generate synthetic contact matrices are not designed for replicability, do not have enough granularity, and not all areas of interest (countries) are included. 
...
[ #TODO is project or predict a better word? Does it matter? ] (decision - use *predict*)
